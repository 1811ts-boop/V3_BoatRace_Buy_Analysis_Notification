...
# 🏆 新・聖杯カレンダー（Tier 1 & Tier 2 厳選ポートフォリオ）
PORTFOLIO = {
    ...
    8: [("P4_Planning", 5, "やや堅め(20-40%)"), ("P3_General_Std", 17, "超堅め(0-20%)"), ("P4_Planning", 12, "普通(40-60%)"), ("P3_General_Std", 24, "やや荒れ(60-80%)")],
    9: [("P4_Planning", 23, "やや堅め(20-40%)")],
    10: [("P3_General_Std", 4, "やや荒れ(60-80%)"), ("P3_General_Std", 17, "やや荒れ(60-80%)")],
    11: [("P4_Planning", 7, "普通(40-60%)")],
